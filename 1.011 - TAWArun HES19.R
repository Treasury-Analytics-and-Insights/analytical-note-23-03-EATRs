...
# HES19 Expenditure subsample

SURVEY <- "HES19"
DB_PATH <- file.path(
  "~/Network-Shares/DataLabNas/MAA",
  "MAA2015-27 IDI based micro simulation modelling of the New Zealand tax and welfare system",
  "TAWA Data/Linked/20211020/Databases/HES19_New_Linked_20211020_Exp.csv"
)
...
SCENARIO_LIST <- list(
  "Parameters/TY19_BEFU22.xlsx" = c("SQ")
)
